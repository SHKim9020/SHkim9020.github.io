(() => {
  ...
  document.addEventListener("DOMContentLoaded",()=>{initSettings();initBlockly();bindUi();initPwaInstall();setSidePanelCollapsed(localStorage.getItem(SIDE_PANEL_KEY)==="1",false);updateWifiName();updateCode();if("serviceWorker" in navigator)navigator.serviceWorker.register("sw.js").catch(()=>{})});
})();
